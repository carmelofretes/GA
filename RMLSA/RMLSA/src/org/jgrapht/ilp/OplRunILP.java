 ...
 */
// -------------------------------------------------------------- -*- Java -*-
// Java version of OplRunILP.cpp of OPL distrib
// --------------------------------------------------------------------------
import java.util.*;
import java.io.*;
import ilog.concert.*;
...
public class OplRunILP {
    ...
    static public void main(String[] args) {
        try {
            ...
            String archivoSalida = args[3]; //aqui se asigna la ruta del archivo salidaCplexILP2_2.txt
            Double timeLimit = Double.valueOf(args[4]); //aqui se asigna el tiempo limite 28800
            oplRun.run(archivoSalida, timeLimit);
    ...
    int run(String archivoSalida, Double timeLimit) throws Exception {
        ...
        if (opl.getModelDefinition().hasMain()) {
            ...
            if (opl.hasCplex()) {
                ...
                if (_cl.isRelaxation()) {
                    ...
                    opl.getCplex().setParam(IloCplex.DoubleParam.TiLim, timeLimit);
